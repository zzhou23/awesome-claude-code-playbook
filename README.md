...
- [Rust CLAUDE.md](recipes/rust-claude.md) - A production-ready guide for Rust development covering Cargo workspaces, Clippy enforcement, unsafe safety rules, and error handling patterns. **When to use:** Use for Rust binaries or libraries where safety, performance, and strict linting are priorities.
